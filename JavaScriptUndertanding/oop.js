...
// create templete with constructor function 
...
Person1.prototype.eatts = function(){

    console.log(`eats`)
}

Person1.prototype.sleeep = function(){
    console.log(`sleep`)
}
...
programmerr.prototype = Object.create(Person1.prototype)

programmerr.eatts()


class Singer extends person1 {
    consturctor (){
